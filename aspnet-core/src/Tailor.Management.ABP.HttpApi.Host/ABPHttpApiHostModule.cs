...
using Tailor.Management.ABP.MultiTenancy;
                ...
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPDomainSharedModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Tailor.Management.ABP.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPDomainModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Tailor.Management.ABP.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPApplicationContractsModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Tailor.Management.ABP.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPApplicationModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Tailor.Management.ABP.Application"));
                });
            }
        }
